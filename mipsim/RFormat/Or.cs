...
namespace mipsim
{
    public class Or : RFormatInstruction
    {
        public Or(uint InstructionWord, uint Address)
        ...
        {
            return base.ToString() + "OR " + RegistersLookupTable.LookupRegister(RegisterDestination) + ", " + RegistersLookupTable.LookupRegister(RegisterSource)
